...
应生成：
- 身份选项：["应届毕业生", "计算机专业学生", "AI求职者"]
- 目标选项：["求职面试", "AI岗位申请", "技术能力展示"]

**用户说："我是独立设计师，想展示我的创意作品"**
应生成：
- 身份选项：["独立设计师", "创意工作者", "自由职业者"]  
- 目标选项：["作品集展示", "客户吸引", "创意能力证明"]

### 3. 智能推荐逻辑
- **贴近用户表达**：选项用词应该接近用户的表达方式
- **提供扩展可能**：为每个维度提供2-4个相关选项
- **包含开放选项**：始终提供"自定义"或"其他"选项
- **考虑上下文**：结合已有信息生成互补选项
...
如果需要收集更多信息：
{
  "suggestions": {
    "user_role": {
      ...
      "options": ["基于用户表达动态生成的选项1", "选项2", "选项3", "让我自己描述"]
    },
    "use_case": {
      "prompt_text": "您主要想用这个页面来做什么？", 
      "options": ["基于用户需求动态生成的选项1", "选项2", "选项3", "其他用途"]
    },
    "style": {
      "prompt_text": "根据您的需求，推荐以下风格：",
      "options": ["基于用户特征推荐的风格1", "风格2", "风格3", "我有其他想法"]
    }
  },
  "follow_up": {
    "missing_fields": ["需要确认的维度"],
    "quick_display": true
  },
  "reply": "我理解您的需求！让我为您生成一些个性化的选项...",
